...
rightRotateTreeTests = testGroup
...
setIntersectionTests = testGroup
...
relCompTests = testGroup
  ...
  , testCase "relComp 3"
  $   relEquiv (relComp [(42, 37)] [(37, 42), (37, 666), (42, 137)])
               [(42, 42), (42, 666)]
  @?= True
  ]

relTransTests = testGroup
  "relTrans Tests"
  [ testCase "relTrans 1"
    $   relEquiv
